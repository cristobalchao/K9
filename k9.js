...
(function( window, $, undefined ){
	...
	function responsive(){
		...
		switch(true) {
            case ( win_w <= 479  ): //Smartphone
            	setElements('smartphone');
            	break;
            
            case ( win_w > 480 && win_w <= 767 ): //Smartphone landscape
                setElements('landSmartphone');
                break;
            
            case ( win_w > 767 && win_w <= 959 ): //Ipad
                setElements('ipad');
                break;

            case ( win_w >= 960 && win_w < 1600 ):
                setElements('normal');
                break;
	...
	$.fn.k9 = function(args) {
		var $this = this,
			...
			_landSmartphone = (!!args.numlandSmartphone) && args.numlandSmartphone || _smartphone,
			_ipad = (!!args.numIpad) && args.numIpad || _landSmartphone,
			_normal = (!!args.numNormal) && args.numNormal || _ipad,
			_extra = (!!args.numExtra) && args.numExtra || _normal,
